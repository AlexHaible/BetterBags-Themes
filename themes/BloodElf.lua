...
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\BloodElfCrest.png'
...
local simpleDark = {
  ...
  Portrait = function(frame)
    ...
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeBloodElf", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
