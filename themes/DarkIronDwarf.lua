...
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\DarkIronDwarfCrest.png'

---@type Theme
local simpleDark = {
  Name = 'Races - Dark Iron Dwarf',
  Description = 'A Race inspired theme.',
  Available = true,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeIronDwarf", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
      ...
      bagButton:SetPoint("TOPLEFT", decoration, "TOPLEFT", -44, 36)
...
themes:RegisterTheme('RacesDarkIronDwarf', simpleDark)