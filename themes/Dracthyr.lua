...
---@type string
local theBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\DracthyrBorder.png'
local theBackground = 'Interface\\ChatFrame\\ChatFrameBackground'
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\DracthyrCrest.png'
...
local simpleDark = {
  Name = 'Races - Dracthyr',
  Description = 'A Dracthyr inspired theme.',
  Available = true,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeDracthyr", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
      ...
      decoration.Border:SetTextureSliceMargins(19, 19, 19, 19);
      decoration.Border:SetTextureSliceMode(Enum.UITextureSliceMode.Tiled);
      decoration.Border:SetPoint("TOPLEFT", frame, "TOPLEFT", -19, 19)
      decoration.Border:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", 19, -19)
      ...
      title:SetPoint("TOP", decoration, "TOP", 0, 22)
      title:SetHeight(30)
      ...
      close:SetPoint("TOPRIGHT", decoration, "TOPRIGHT", 20, 20)
      close:SetScript("OnClick", function()
        frame.Owner:Hide()
      end)

      local searchBox = search:CreateBox(frame.Owner.kind, decoration --[[@as Frame]])
      searchBox.frame:SetPoint("TOP", decoration, "TOP", 0, -4)
...
themes:RegisterTheme('RacesDracthyr', simpleDark)