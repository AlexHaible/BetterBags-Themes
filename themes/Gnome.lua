...
local simpleDark = {
  Name = 'Races - Gnome',
  Description = 'A Gnome inspired theme.',
  Available = false,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeGnome", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
...
themes:RegisterTheme('RacesGnome', simpleDark)