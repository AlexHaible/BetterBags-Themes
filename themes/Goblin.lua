...
local simpleDark = {
  Name = 'Races - Goblin',
  Description = 'A Goblin inspired theme.',
  Available = false,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeGoblin", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
...
themes:RegisterTheme('RacesGoblin', simpleDark)