...
---@type string
local theBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\HighmountainTaurenBorder.png'
local theBackground = 'Interface\\AddOns\\BetterBags-Themes\\textures\\LightGrassBackground.png'
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\HighmountainTaurenCrest.png'
...
---@type Theme
local simpleDark = {
  Name = 'Races - Highmountain Tauren',
  Description = 'A Highmountain Tauren inspired theme.',
  Available = true,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeHighmountainTauren", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
      ...
      decoration:SetBackdropColor(0.3764705882352941, 0.5019607843137255, 0.24705882352941178, 0.75)
...
themes:RegisterTheme('RacesHighmountainTauren', simpleDark)