...
---@type Theme
local simpleDark = {
  Name = 'Races - Lightforged Draenei',
  Description = 'A Lightforged Draenei inspired theme.',
  Available = false,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeLightforgedDraenei", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
...
themes:RegisterTheme('RacesLightforgedDraenei', simpleDark)