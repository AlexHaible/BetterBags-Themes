...
---@type string
local theBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MacOSDarkBorderTop.png'
local theRightBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MacOSDarkBorderRight.png'
local theLeftBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MacOSDarkBorderLeft.png'
local theBottomBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MacOSDarkBorderBottom.png'
local theBackground = 'Interface\\ChatFrame\\ChatFrameBackground'
local theSearchBox = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MacOSDarkSearch.png'
local closeButton = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MacOSDarkCloseButton.png'
local menuButton = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MacOSDarkMenuButton.png'
...
local simpleDark = {
  ...
  Portrait = function(frame)
    ...
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeMacOSDark", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
      ...
      decoration:SetBackdropColor(0, 0, 0, 0.75)
      ...
      decoration.BottomBorder:SetTextureSliceMargins(8, 0, 8, 8)
      decoration.BottomBorder:SetTextureSliceMode(Enum.UITextureSliceMode.Tiled)
      decoration.BottomBorder:SetPoint("BOTTOMLEFT", frame, "BOTTOMLEFT", 0, -8)
      decoration.BottomBorder:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", 0, -8)
      decoration.BottomBorder:SetVertexColor(1, 1, 1)

      decoration.LeftBorder = decoration:CreateTexture()
      decoration.LeftBorder:SetTexture(theLeftBorder)
      decoration.LeftBorder:SetPoint("TOPLEFT", frame, "TOPLEFT", 0, 0)
      decoration.LeftBorder:SetPoint("BOTTOMLEFT", frame, "BOTTOMLEFT", 2, 0)
      decoration.LeftBorder:SetVertTile(true)
      decoration.LeftBorder:SetHorizTile(false)
      decoration.LeftBorder:SetVertexColor(1, 1, 1)

      decoration.RightBorder = decoration:CreateTexture()
      decoration.RightBorder:SetTexture(theRightBorder)
      decoration.RightBorder:SetPoint("TOPRIGHT", frame, "TOPRIGHT", -0, 0)
      decoration.RightBorder:SetPoint("BOTTOMRIGHT", frame, "BOTTOMRIGHT", -2, 0)
      decoration.RightBorder:SetVertTile(true)
      decoration.RightBorder:SetHorizTile(false)
      decoration.RightBorder:SetVertexColor(1, 1, 1)
...
themes:RegisterTheme('MacOSDark', simpleDark)