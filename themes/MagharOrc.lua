...
---@type string
local theBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MagharOrcBorder.png'
local theBackground = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MagharOrcBackground.png'
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\MagharOrcCrest.png'
...
---@type Theme
local simpleDark = {
  Name = 'Races - Mag\'har Orc',
  Description = 'A Mag\'har Orc inspired theme.',
  Available = true,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeMagharOrc", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
...
themes:RegisterTheme('RacesMagharOrc', simpleDark)