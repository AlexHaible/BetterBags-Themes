...
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\NightElfCrest.png'
...
local simpleDark = {
  ...
  Portrait = function(frame)
    ...
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeNightElf", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
      ...
      bagButton:SetPoint("TOPLEFT", decoration, "TOPLEFT", -22, 28)
