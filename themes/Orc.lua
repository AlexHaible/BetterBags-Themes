...
local theBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\OrcBorder.png'
local theBackground = 'Interface\\ChatFrame\\ChatFrameBackground'
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\OrcCrest.png'
...
local simpleDark = {
  ...
  Portrait = function(frame)
    ...
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeOrc", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
