...
---@type string
local theBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\TaurenBorder.png'
local theBackground = 'Interface\\AddOns\\BetterBags-Themes\\textures\\LightGrassBackground.png'
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\TaurenCrest.png'
...
local simpleDark = {
  Name = 'Races - Tauren',
  Description = 'A Tauren inspired theme.',
  Available = true,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeTauren", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
      ...
      decoration:SetBackdropColor(0.5, 0.5, 0.5, 0.8)
...
themes:RegisterTheme('RacesTauren', simpleDark)