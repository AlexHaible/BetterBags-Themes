...
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\UndeadCrest.png'

---@type Theme
local simpleDark = {
  Name = 'Races - Undead',
  Description = 'A Undead inspired theme.',
  Available = true,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeUndead", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
...
themes:RegisterTheme('RacesUndead', simpleDark)