...
---@type string
local theBorder = 'Interface\\AddOns\\BetterBags-Themes\\textures\\VoidElfBorder.png'
local theBackground = 'Interface\\AddOns\\BetterBags-Themes\\textures\\VoidRockBackground.png'
local theCrest = 'Interface\\AddOns\\BetterBags-Themes\\textures\\VoidElfCrest.png'
...
local simpleDark = {
  ...
  Portrait = function(frame)
    ...
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeVoidElf", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
...
themes:RegisterTheme('RacesVoidElf', simpleDark)