...
---@type Theme
local simpleDark = {
  Name = 'Races - Zandalari Troll',
  Description = 'A Zandalari Troll inspired theme.',
  Available = false,
  Portrait = function(frame)
    local decoration = decoratorFrames[frame:GetName()]
    if not decoration then
      -- Backdrop
      decoration = CreateFrame("Frame", frame:GetName().."ThemeZandalariTroll", frame, "BackdropTemplate") --[[@as SimpleDarkDecoration]]
...
themes:RegisterTheme('RacesZandalariTroll', simpleDark)